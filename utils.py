...
# self.anchors = utils.generate_pyramid_anchors(config.RPN_ANCHOR_SCALES,(8, 16, 32, 64, 128) # Length of square anchor side in pixels
#                                               config.RPN_ANCHOR_RATIOS,[0.5, 1, 2]
#                                               config.BACKBONE_SHAPES,  see above
