...
class Config(object):
    ...
    RPN_ROIS_IOU_GT_BOX_POSITIVE_TRESH = 0.25 #original 0.5 #this is between proposed rois and ground-truth images
    ...
    ANCHOR_IOU_POS_TRESH = 0.25 #original 0.7 and 0.3
    ANCHOR_IOU_NEG_TRESH = 0.15
