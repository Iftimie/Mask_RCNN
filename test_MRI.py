...
model.load_weights("logs/shapes20180117T0942/mask_rcnn_shapes_0016.h5",by_name=True)

for i in range(1,6):
    original_image, image_meta, gt_bbox = modellib.load_image_gt(None,inference_config,image_id=i, use_mini_mask=False)
